...
class TestDialogueFrameBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.DialogueFrame.builder import add_to_composition
...
class TestDialogueFrameToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.DialogueFrame.tool import register_tool
