...
class TestVerticalBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.Vertical.builder import add_to_composition
...
class TestVerticalToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.Vertical.tool import register_tool
