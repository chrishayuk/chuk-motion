...
class TestStackedReactionBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.StackedReaction.builder import add_to_composition
...
class TestStackedReactionToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.StackedReaction.tool import register_tool
