...
class TestThreeRowLayoutBuilderMethod:
    """Tests for ThreeRowLayout builder method."""

    def test_add_to_composition_basic(self):
        """Test add_to_composition creates ComponentInstance."""
        from chuk_motion.components.layouts.ThreeRowLayout.builder import add_to_composition
        ...
        assert builder.components[0].component_type == "ThreeRowLayout"
    ...
    def test_add_to_composition_all_props(self):
        ...
        assert props["middle"] == {"type": "middle"}
        assert props["bottom"] == {"type": "bottom"}
        assert props["top_height"] == 30.0
        assert props["middle_height"] == 40.0
        assert props["bottom_height"] == 30.0
...
class TestThreeRowLayoutToolRegistration:
    """Tests for ThreeRowLayout MCP tool registration."""

    def test_register_tool(self):
        """Test tool registration."""
        from unittest.mock import Mock

        from chuk_motion.components.layouts.ThreeRowLayout.tool import register_tool
    ...
    def test_tool_execution(self):
        ...
        assert result_data["component"] == "ThreeRowLayout"
    ...
    def test_tool_execution_error_handling(self):
        ...
        with patch.object(timeline, "add_three_row_layout", side_effect=Exception("Test error")):
            result = asyncio.run(tool_func())
            result_data = json.loads(result)
            assert "error" in result_data
