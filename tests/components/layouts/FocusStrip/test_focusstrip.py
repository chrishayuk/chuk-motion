...
class TestFocusStripBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.FocusStrip.builder import add_to_composition
...
class TestFocusStripToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.FocusStrip.tool import register_tool
