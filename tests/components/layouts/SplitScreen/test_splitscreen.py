# chuk-mcp-remotion/src/chuk_mcp_remotion/components/layouts/SplitScreen/test_splitscreen.py
"""
...
class TestSplitScreenBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.SplitScreen.builder import add_to_composition
...
class TestSplitScreenToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.SplitScreen.tool import register_tool
    ...
    def test_tool_execution(self):
        ...
        composition.add_split_screen = Mock()
        ...
        assert composition.add_split_screen.called
    ...
    def test_tool_execution_error_handling(self):
        ...
        composition = Mock()
        project_manager.current_composition = composition
        composition.add_split_screen = Mock(side_effect=Exception("Test error"))
