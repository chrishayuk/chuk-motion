...
class TestHUDStyleBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.HUDStyle.builder import add_to_composition
...
class TestHUDStyleToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.HUDStyle.tool import register_tool
