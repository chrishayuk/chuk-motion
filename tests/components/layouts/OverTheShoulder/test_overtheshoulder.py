...
class TestOverTheShoulderBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_mcp_remotion.components.layouts.OverTheShoulder.builder import add_to_composition
...
class TestOverTheShoulderToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_mcp_remotion.components.layouts.OverTheShoulder.tool import register_tool
