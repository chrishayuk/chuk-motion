# chuk-motion/tests/components/text_animations/FuzzyText/test_fuzzytext.py
"""Tests for FuzzyText component."""
...
class TestFuzzyTextBasic:
    """Basic FuzzyText generation tests."""

    @pytest.mark.skip(reason="Component uses new structure with templates in component dir")
    def test_basic_generation(self, component_builder, theme_name):
        """Test basic FuzzyText generation with all props."""
        ...
        assert "FuzzyText" in tsx
        assert_valid_typescript(tsx)
        assert_has_interface(tsx, "FuzzyText")
...
class TestFuzzyTextBuilderMethod:
    """Tests for FuzzyText builder method."""

    def test_add_to_composition_basic(self):
        """Test add_to_composition creates ComponentInstance."""
        from chuk_motion.components.text_animations.FuzzyText.builder import (
            add_to_composition,
        )
        ...
        assert builder.components[0].component_type == "FuzzyText"
...
class TestFuzzyTextToolRegistration:
    """Tests for FuzzyText MCP tool."""

    def test_register_tool(self):
        """Test tool registration."""
        from chuk_motion.components.text_animations.FuzzyText.tool import register_tool
    ...
    def test_tool_execution(self):
        ...
        assert result_data["component"] == "FuzzyText"
    ...
    def test_tool_execution_with_text_color(self):
        ...
        # Verify the component has textColor in props
