...
class TestHorizontalBarChartBasic:
    """Basic HorizontalBarChart generation tests."""

    def test_basic_generation(self, component_builder, theme_name):
        """Test basic HorizontalBarChart generation with all props."""
        ...
        assert "HorizontalBarChart" in tsx
        assert_valid_typescript(tsx)
        assert_has_interface(tsx, "HorizontalBarChart")

    def test_minimal_props(self, component_builder, theme_name):
        """Test HorizontalBarChart with minimal props."""
        tsx = component_builder.build_component("HorizontalBarChart", {}, theme_name)

        assert tsx is not None


class TestHorizontalBarChartRendering:
    """Tests for HorizontalBarChart rendering."""
...
class TestHorizontalBarChartBuilderMethod:
    """Tests for HorizontalBarChart builder method."""
    ...
    def test_add_to_composition_basic(self):
        ...
        assert builder.components[0].component_type == "HorizontalBarChart"
    ...
    def test_add_to_composition_all_props(self):
        ...
        add_to_composition(
            builder, data=data, title="Test Chart", xlabel="X Axis", start_time=1.0, duration=5.0
        )
...
class TestHorizontalBarChartToolRegistration:
    """Tests for HorizontalBarChart MCP tool."""
    ...
    def test_tool_execution(self):
        ...
        composition.add_horizontal_bar_chart = Mock()
        ...
        assert composition.add_horizontal_bar_chart.called
        result_data = json.loads(result)
        assert result_data["component"] == "HorizontalBarChart"
    ...
    def test_tool_execution_error_handling(self):
        ...
        composition = Mock()
        project_manager.current_composition = composition
        composition.add_horizontal_bar_chart = Mock(side_effect=Exception("Test error"))
