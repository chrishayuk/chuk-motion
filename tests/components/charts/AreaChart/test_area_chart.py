# chuk-motion/src/chuk_motion/components/charts/AreaChart/test_area_chart.py
"""
...
class TestAreaChartBuilderMethod:
    ...
    def test_add_to_composition_basic(self):
        ...
        from chuk_motion.components.charts.AreaChart.builder import add_to_composition
...
class TestAreaChartToolRegistration:
    ...
    def test_register_tool(self):
        ...
        from chuk_motion.components.charts.AreaChart.tool import register_tool
    ...
    def test_tool_execution_error_handling(self):
        ...
        # Mock add_area_chart to raise exception
        with patch.object(timeline, "add_area_chart", side_effect=Exception("Test error")):
            result = asyncio.run(tool_func(data='[{"label": "A", "value": 10}]', duration=4.0))
