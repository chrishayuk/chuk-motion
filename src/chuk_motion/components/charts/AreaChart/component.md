...
Animated area chart showing trends with filled gradient

## Overview

The `AreaChart` component is a chart component in the chuk-motion library.
...
- Type: `array`
- **Required**
- Array of data points as [x, y] or {x, y, label}
