...
Realistic device frame (phone, tablet, laptop) with auto-scaling, glare effects, and content display

## Overview

The `DeviceFrame` component is a frame component in the chuk-motion library.
