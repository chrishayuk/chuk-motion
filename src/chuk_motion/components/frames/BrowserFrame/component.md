...
Realistic browser window with URL bar, tabs, swappable themes (Chrome, Firefox, Safari, Arc), and optional status bar

## Overview

The `BrowserFrame` component is a frame component in the chuk-motion library.
