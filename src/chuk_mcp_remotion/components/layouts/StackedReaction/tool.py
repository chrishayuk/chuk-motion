...
def register_tool(mcp, project_manager):
    ...
    async def remotion_add_stacked_reaction(
        ...
        Args:
            original_content: JSON component for original video
            reaction_content: JSON component for reaction video
        ...
        def _add():
            ...
            try:
                component = ComponentInstance(
                    ...
                    duration_frames=0,
                    props={
                        "original_content": original_parsed,
                        "reaction_content": reaction_parsed,
                        "layout": layout,
